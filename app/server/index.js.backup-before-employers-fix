...
// Security headers apply globally to all responses
app.use(securityHeaders);
// Response sanitization applies globally
app.use(sanitizeResponse);
// Bot blocking and behavior detection scoped to /api/* only
// Prevents false positives blocking frontend HTML pages and static assets
app.use('/api', botBlocker);
app.use('/api', behaviorDetector);
honeypotSetup(app);
...
app.use('/api/admin/reconcile', require('./routes/admin-bank-reconcile'));
